...
<head>
    ...
    <meta property="og:description" content="Vilarthe en una marca de ropa y accesorios creada en el departamento de Lambayeque
        en el norte del Perú con el objetivo de hacerle llegar lo mejor de nuestras fibras elaboradas con el
        mejor algodón de la región legado de nuestro pasado milenario.
        Vilarthe ha creado la línea LAZOS BABY CLOTHING diseñada pensando en proteger la sensible y
         delicada piel de los bebés, están elaborados con algodón peruano (pima o nativo),
         Orgánicos, y teñidos 100% con tintes naturales, los accesorios son antialérgicos libres de níquel. ">
